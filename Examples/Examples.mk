...
$(BIN): ../../Communications/$(TARGET)/libOrionComm.a ../../Utils/$(TARGET)/libOrionUtils.a $(OBJS)
	$(V)$(CC) -o $(BIN) $(OBJS) -L../../Communications/$(TARGET) -L../../Utils/$(TARGET) -lOrionComm -lOrionUtils -lm -L../../Communications/$(TARGET) -L../../Utils/$(TARGET) -lOrionComm -lOrionUtils -lm $(LDFLAGS) $(QOUT) 
